# DEPRECATED — replaced by build_pdfs.py (Playwright HTML→PDF).
# This hardcoded ReportLab script is kept for reference only.
# Delete after confirming build_pdfs.py produces acceptable output.
